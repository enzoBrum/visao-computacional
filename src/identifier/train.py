...
training_data = ImageFolder(
    "/home/erb/ufsc/ine5448/extracted-rois/train", training_transforms
)
...
for i in range(epochs):
    ...
    with torch.no_grad():
        ...
        print(
            f"Epoch: {i+1}, Avg. Loss: {avg_loss}, FAR: {false_pairs_accepted/false_pairs_total}, FRR: {genuine_pairs_rejected/genuine_pairs_total}"
        )
