...
class Hrnetv2_w18_dark:
    ...
    def postprocess(
        ...
        image = cv2.circle(image, (midpoint_x, round(rect_center_y)), 3, (255, 60, 128), 3)
...
if __name__ == "__main__":
    ...
    hrnet = Hrnetv2_w18_dark(argv[2], ["CPUExecutionProvider"])
    roi, keypoints = hrnet.detect(imgs[0])
    ...
    result = cv2.drawContours(img, [box], 0, (0, 0, 255), 24)
